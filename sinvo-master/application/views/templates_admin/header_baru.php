...
<head>
    ...
    <meta name="keywords" content="Buat Invoice dengan&nbsp;mudah!">
    <meta name="description" content="">
    <meta name="page_type" content="np-template-header-footer-from-plugin">
    <title>Invoice - Owner</title>
    <link rel="stylesheet" href="<?= base_url() ?>assets/css/nicepage.css" media="screen">
    <link rel="stylesheet" href="<?= base_url() ?>assets/css/nicepage.min.css" media="screen">
    <script class="u-script" type="text/javascript" src="<?= base_url() ?>assets/js/jquery.js" defer=""></script>
    <script class="u-script" type="text/javascript" src="<?= base_url() ?>assets/js/chart.js" defer=""></script>
