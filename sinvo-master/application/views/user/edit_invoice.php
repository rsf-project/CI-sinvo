<div class="container">
    ...
    <?php foreach ($orders as $ord) : ?>
        <form action="<?php echo base_url() . 'user/add_invoice/update' ?>" id="invoice_form" method="POST">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <a href="<?php echo base_url('user/manage_invoice/index') ?>" class="btn btn-danger font-weight-bold float-right" id="btnCancel"><i class="fas fa-times"></i> Cancel</a>
                </div>
            </div>
        </form>
    <?php endforeach; ?>
