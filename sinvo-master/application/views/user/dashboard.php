<body data-home-page="#" data-home-page-title="Invoice" class="u-body">
    <header class="u-clearfix u-header u-header" id="sec-e8e6">
        <div class="u-clearfix u-sheet u-sheet-1">
            <a href="<?= base_url('user/dashboard') ?>" class="u-image u-logo u-image-1">
            ...
            <nav class="u-menu u-menu-dropdown u-offcanvas u-menu-1">
                ...
                <div class="u-custom-menu u-nav-container">
                    <ul class="u-nav u-unstyled u-nav-1">
                        <li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-black u-text-hover-palette-2-base" href="<?= base_url('user/manage_invoice') ?>" style="padding: 10px 20px;">Manage Invoice</a>
                        </li>
                        <li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-black u-text-hover-palette-2-base" href="<?= base_url('user/manage_expense') ?>" style="padding: 10px 20px;">Manage Expense</a>
                        </li>
    ...
    <section class="u-clearfix u-section-1" id="sec-2633">
        ...
        <a href="<?= base_url('user/add_invoice') ?>" class="u-btn u-btn-round u-button-style u-custom-color-1 u-hover-palette-1-light-1 u-radius-50 u-btn-1">BUAT INVOICE</a>
