    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link bg-light" href="<?php echo base_url('user/dashboard') ?>">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-light py-2 collapse-inner rounded">
                        ...
                        <a class=" collapse-item" style="color: black;" href="<?php echo base_url('user/add_invoice') ?>">Add Invoice</a>
                        <a class=" collapse-item" style="color: black;" href="<?php echo base_url('user/manage_invoice') ?>">Manage Invoice</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-light py-2 collapse-inner rounded">
                        <h6 class="collapse-header" style="color: black;">Action :</h6>
                        <a class="collapse-item" href="<?php echo base_url('user/add_expense') ?>" style="color: black;">Add Expenses</a>
                        <a class="collapse-item" href="<?php echo base_url('user/manage_expense') ?>" style="color: black;">Manage Expenses</a>
                    </div>
                </div>
            </li>
            <!-- Divider -->
