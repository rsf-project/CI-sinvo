<div class="container">
    ...
    <form action="<?php echo base_url() . 'admin/add_invoice/tambah' ?>" id="invoice_form" method="POST">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <a href="<?php echo base_url('admin/manage_invoice') ?>" class="btn btn-danger font-weight-bold float-right" id="btnCancel"><i class="fas fa-times"></i> Cancel</a>
