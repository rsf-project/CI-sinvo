...
class Add_expense extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('admin/add_expense');
    ...
    public function tambah()
    {
        ...
        $query = $this->db->query("INSERT INTO tbl_expense VALUES ('$_POST[expense_id]','$_POST[expense_nama]','$_POST[expense_qty]','$_POST[expense_harga]','$_POST[expense_total]','$_POST[expense_keterangan]','$_POST[expense_created_at]')");
